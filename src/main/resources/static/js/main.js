...
loginbtn?.addEventListener('click', (e) => {
    ...
    else if(lgnfrm.passwd.value === '') alert('비밀번호를 입력해주세요');
    else{
        lgnfrm.method = 'post';
        lgnfrm.action = '/login';
        lgnfrm.submit();
...
function showPlayNStop() {
    if (indexMovie.paused) {
        indexMoviePlayStop.innerHTML = '<i class="fa-solid fa-pause" style="color: #343434; margin-left: 30%;"></i>';
    } else if (indexMovie.played) {
        indexMoviePlayStop.innerHTML = '<i class="fa-solid fa-play" style="color: #343434; margin-left: 30%;"></i>';
    }
}
